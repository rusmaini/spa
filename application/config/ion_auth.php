 ...
 */
$config['site_title']                 = "MyKEKAS";       // Site Title, example.com
$config['admin_email']                = "admin@mykekas.com"; // Admin Email, admin@example.com
...
$config['email_activation']           = TRUE;                // Email Activation for registration //FALSE;
$config['manual_activation']          = TRUE;                // Manual Activation for registration //FALSE;
 ...
 */
$config['use_ci_email'] = TRUE; //FALSE; // Send Email using the builtin CI email class, if false it will return the code and the identity
...
$config['error_start_delimiter']   = '<p class="alert alert-danger">';		// Error message start delimiter
